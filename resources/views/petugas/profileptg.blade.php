        ...
        <div class="row">
            <div class="col-md-3 border-right">
                <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5"
                        ...
                        class="font-weight-bold">{{Auth::user()->name}}</span><span class="text-black-50">{{Auth::user()->email}}</span><span> </span></div>
            </div>
                ...
                <div class="p-3 py-5">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12"><label class="labels">Nama</label><input type="text" class="form-control"
                                placeholder="Masukkan Nama" value="{{Auth::user()->name}}"></div>
                        <div class="col-md-12"><label class="labels">Username</label><input type="text"
                                class="form-control" placeholder="Masukkan Username" value="{{Auth::user()->username}}"></div>
                        ...
                        <div class="col-md-12"><label class="labels">Password</label><input type="password"
                                class="form-control" placeholder="Masukkan Password" value="{{Auth::user()->password}}"></div>
            ...
            <div class="col-md-4">
                <div class="p-3 py-5">
                    ...
                    <form id="updateRoleForm" method="POST" action="{{ route('update-rolePtg') }}">
                        @csrf
                        <input type="hidden" name="role" id="roleInput" value="">
                    </form>

                    <a href="javascript:void(0);" onclick="changeRole('pengguna')" class="btn btn-primary btn-lg mb-3">
